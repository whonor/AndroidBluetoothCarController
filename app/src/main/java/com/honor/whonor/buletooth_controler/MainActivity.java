...
private static final String TAG = "Bluetooth_controler";
    ...
    CheckBox checkBox = null;//checkbox自动模式选择
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if (isChecked){
                    checkFlag = true;
                    Toast.makeText(getApplicationContext(), "自动模式开启", Toast.LENGTH_SHORT).show();
                    try {
                        outStream = btSocket.getOutputStream();
                    }catch (IOException e){
                        Log.e(TAG, "Output stream creation failed", e);
                    ...
                    checkFlag = false;
                    Toast.makeText(getApplicationContext(), "手动模式开启", Toast.LENGTH_SHORT).show();
                    try {
                        outStream = btSocket.getOutputStream();
                    }catch (IOException e){
                        Log.e(TAG, "Output stream creation failed", e);
